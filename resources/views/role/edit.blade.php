                    ...
                    <div class="col-md-12">
                        <form action="{{ url('backend/role') }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                @endif
                                <input class="form-control" type="text" name="role" value="{{ $role->name ? $role->name : old('name') }}" />
                            </div>
                            <div class="form-group">
                             ...
                             @endif
                             <input class="form-control" type="text" name="slug" value="{{ $role->slug ? $role->slug : old('slug') }}" />
                         </div>
                         ...
                         <label class="control-label" for="slug">User</label>
                            ...
                            <div class="checkbox">
                                <label><input type="checkbox" name="role_permission[user.edit]" value="true"
                                     
                                >User Edit</label>
                            </div>
                            <div class="checkbox">
                                <label><input type="checkbox" name="role_permission[user.delete]" value="true">
                                User Delete</label>
                            </div>
                        </div>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="checkbox">
                                <label><input type="checkbox" name="role_permission[role.create]" value="true">Role Create
                            </div>
                            <div class="checkbox">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <div class="checkbox">
                                <label>{{$role->permission['product.show']}}<input type="checkbox" name="role_permission[product.show]" value="true">product Show</label>
                            </div>
